        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isActive = table.Column<bool>(nullable: false),
                    isAlocado = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Funcionarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Funcionarios_Gft_GftId",
                        column: x => x.GftId,
                        principalTable: "Gft",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tecnologia_Id = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vaga_Tecnologias", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Funcionario_Tecnologias", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Funcionario_Tecnologias_Funcionario_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vaga_Tecnologias_Vaga_Id",
                table: "Vaga_Tecnologias",
                column: "Vaga_Id");
        }
